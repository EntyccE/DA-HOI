...
def semantic_mask(image, pred, label_to_mask, save=False, dir=None, index=None):
  ...
  if save:
    plt.savefig(open(dir+"/example_{}_s.png".format(index), 'wb'), format='png',bbox_inches='tight', dpi=200)
    plt.close()
