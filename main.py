...
from models import build_model, MyStableDiffusion
from arguments import get_args_parser
from utils.scheduler import create_scheduler
# from models import LdmExtractor
...
def main(args):
    ...
    if args.distributed:
        ...
        # Example of defining LdmExtractor
        extractor = MyStableDiffusion(device=args.gpu2)
    else:
        extractor = MyStableDiffusion(device="cuda:1")
    ...
    # Load only one dataset based on args.eval
    if args.eval:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(model, extractor, criterion, data_loader_train, optimizer, noun_list_train,
                                      device, epoch, args)
